...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=iPlug2OnnxRuntime Demo Installer\n"
      else:
        line="OutputBaseFilename=iPlug2OnnxRuntime Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the iPlug2OnnxRuntime Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the iPlug2OnnxRuntime installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=iPlug2OnnxRuntime Demo installer\n"
     else:
       line="SetupWindowTitle=iPlug2OnnxRuntime installer\n"
