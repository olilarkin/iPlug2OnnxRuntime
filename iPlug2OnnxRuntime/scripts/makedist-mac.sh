...
NOTARIZE_BUNDLE_ID=com.AcmeInc.iPlug2OnnxRuntime
NOTARIZE_BUNDLE_ID_DEMO=com.AcmeInc.iPlug2OnnxRuntime.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/iPlug2OnnxRuntime.iss
#  git checkout installer/iPlug2OnnxRuntime.pkgproj
